...
export function postFriendsRequest(c: AppContext) {
  // TODO:
  // 1) Authenticate user
...
export function postFriendsAccept(c: AppContext) {
  // TODO:
  // 1) Authenticate user
