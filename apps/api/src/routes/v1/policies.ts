...
export async function getPolicies(c: AppContext) {
	// TODO: authenticate, list policies for current user
	return c.json({ error: "Not implemented" }, 501);
}

export async function putPoliciesGlobal(c: AppContext) {
	// TODO:
	// 1) authenticate
...
export async function putPoliciesFriend(c: AppContext) {
	// TODO: authenticate, validate friendId param + body, upsert friend policy
	return c.json({ error: "Not implemented" }, 501);
}

export async function putPoliciesGroup(c: AppContext) {
...
export async function getPoliciesEffective(c: AppContext) {
	// TODO:
	// 1) authenticate
